...
public class ExpertAssignmentService {
  ...
  /** Score interne (0–100+) utilisé pour le classement et l’affichage après assignation auto. */
  public double computeMatchScore(ExpertHassen expert, Claim claim) {
    return calculateExpertScore(expert, claim);
  }
