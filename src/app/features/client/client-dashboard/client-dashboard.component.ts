...
export class ClientDashboardComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  // ── Client simulé (à remplacer par AuthService plus tard) ─────────────────
  readonly CLIENT_NAME = 'Ahmed Ben Ali';
  readonly CLIENT_REF = 'SA-2024-00847';
  readonly CLIENT_INIT = 'AB';

  // ── Navigation ────────────────────────────────────────────────────────────
  navItems: NavItem[] = [
    { icon: 'dashboard', label: 'Tableau de bord', route: '/client/dashboard', active: true },
    ...
    { icon: 'comment', label: 'Mes réclamations', route: '/client/reclamations' },
